...
namespace ControlActive.Areas.Admin.Controllers
{
    ...
    public class OrganizationsController : Controller
    {
        ...
        {
            return View(await _context.Organizations.Where(d => d.IsActive == true).Include(d => d.Region).OrderBy(i => i.RegionId).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("OrganizationId,OrganizationName,RegionId,IsActive")] Organization organization)
        {
            ...
            ViewData["RegionId"] = new SelectList(_context.Regions, "RegionId", "RegionName", organization.RegionId);
            return View(organization);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrganizationId,OrganizationName,RegionId,IsActive")] Organization organization)
        {
