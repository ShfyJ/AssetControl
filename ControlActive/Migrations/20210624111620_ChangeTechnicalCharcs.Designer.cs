...
namespace ControlActive.Migrations
{
    ...
    [Migration("20210624111620_ChangeTechnicalCharcs")]
    partial class ChangeTechnicalCharcs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlActive.Models.RealEstate", b =>
                {
                    ...
                    b.Property<int?>("OnTimePaymentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SubmissionOnBiddingId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ControlActive.Models.TransferredAsset", b =>
                {
                    ...
                    b.Property<bool>("AssetEvaluated")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ControlActive.Models.FileModel", b =>
                {
                    ...
                    b.HasOne("ControlActive.Models.ReductionInAsset", "ReductionInAsset")
                        .WithMany()
                        .HasForeignKey("ReductionInAssetId");
            ...
            modelBuilder.Entity("ControlActive.Models.RealEstate", b =>
                {
                    ...
                    b.HasOne("ControlActive.Models.AssetEvaluation", "AssetEvaluation")
                        .WithOne("RealEstate")
                        .HasForeignKey("ControlActive.Models.RealEstate", "AssetEvaluationId");
                    ...
                    b.HasOne("ControlActive.Models.InstallmentAsset", "InstallmentAsset")
                        .WithOne("RealEstate")
                        .HasForeignKey("ControlActive.Models.RealEstate", "InstallmentAssetId");

                    b.HasOne("ControlActive.Models.OneTimePaymentAsset", "OneTimePaymentAsset")
                        .WithOne("RealEstate")
                        .HasForeignKey("ControlActive.Models.RealEstate", "OnTimePaymentId");
                    ...
                    b.HasOne("ControlActive.Models.ReductionInAsset", "ReductionInAsset")
                        .WithOne("RealEstate")
                        .HasForeignKey("ControlActive.Models.RealEstate", "ReductionInAssetId");
                    ...
                    b.HasOne("ControlActive.Models.SubmissionOnBidding", "SubmissionOnBidding")
                        .WithOne("RealEstate")
                        .HasForeignKey("ControlActive.Models.RealEstate", "SubmissionOnBiddingId");
                    ...
                    b.Navigation("SubmissionOnBidding");
            ...
            modelBuilder.Entity("ControlActive.Models.ReductionInAsset", b =>
                {
                    b.HasOne("ControlActive.Models.FileModel", "SolutionFile")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlActive.Models.Share", b =>
                {
                    ...
                    b.HasOne("ControlActive.Models.AssetEvaluation", "AssetEvaluation")
                        .WithOne("Share")
                        .HasForeignKey("ControlActive.Models.Share", "AssetEvaluationId");
                    ...
                    b.HasOne("ControlActive.Models.InstallmentAsset", "InstallmentAsset")
                        .WithOne("Share")
                        .HasForeignKey("ControlActive.Models.Share", "InstallmentAssetId");

                    b.HasOne("ControlActive.Models.OneTimePaymentAsset", "OneTimePaymentAsset")
                        .WithOne("Share")
                        .HasForeignKey("ControlActive.Models.Share", "OnTimePaymentId");

                    b.HasOne("ControlActive.Models.ReductionInAsset", "ReductionInAsset")
                        .WithOne("Share")
                        .HasForeignKey("ControlActive.Models.Share", "ReductionInAssetId");
                    ...
                    b.HasOne("ControlActive.Models.SubmissionOnBidding", "SubmissionOnBidding")
                        .WithOne("Share")
                        .HasForeignKey("ControlActive.Models.Share", "SubmissionOnBiddingId");
