...
namespace ControlActive.Migrations
{
    ...
    [Migration("20221129060614_AddIsActiveColumnToTemplateTable")]
    partial class AddIsActiveColumnToTemplateTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlActive.Models.NotiMessage", b =>
                {
                    b.Property<int>("NotiMessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("NotiMessageId");

                    b.ToTable("NotiMessageLibrary");
                });
            ...
            modelBuilder.Entity("ControlActive.Models.RealEstate", b =>
                {
                    ...
                    b.Property<string>("MaintenanceCostForYear")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlActive.Models.Share", b =>
                {
                    ...
                    b.Property<int>("AuditConclusionId")
                        .HasColumnType("integer");

                    b.Property<string>("AuditConclusionLink")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("BalanceSheetLink")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("FinancialResultLink")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MaintanenceCostForYear")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ControlActive.Models.Shareholder", b =>
                {
            ...
            modelBuilder.Entity("ControlActive.Models.SharesAndHolders", b =>
                {
                    b.Property<int>("ShareId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ShareId", "ShareholderId");

                    b.HasIndex("ShareholderId");

                    b.ToTable("SharesAndHolders");
                });
            ...
            modelBuilder.Entity("ControlActive.Models.Template", b =>
                {
                    b.Property<int>("TemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("HasAssetEvaluation")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasAuction")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasInstallmentAsset")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasOneTimePaymentAsset")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasReductionInAsset")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasTransferredAssets")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ShareShareholder", b =>
                {
                    b.Property<int>("ShareholdersShareholderId")
                        .HasColumnType("integer");

                    b.Property<int>("SharesShareId")
                        .HasColumnType("integer");

                    b.HasKey("ShareholdersShareholderId", "SharesShareId");

                    b.HasIndex("SharesShareId");

                    b.ToTable("ShareShareholder");
                });
            ...
            modelBuilder.Entity("ControlActive.Models.FileModel", b =>
                {
                    ...
                    b.HasOne("ControlActive.Models.Template", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlActive.Models.InstallmentAsset", b =>
                {
                    b.HasOne("ControlActive.Models.InstallmentStep2", "Step2")
                        .WithMany()
                        .HasForeignKey("InstallmentStep2Id");
            ...
            modelBuilder.Entity("ControlActive.Models.OneTimePaymentAsset", b =>
                {
                    b.HasOne("ControlActive.Models.OneTimePaymentStep2", "Step2")
                        .WithMany()
                        .HasForeignKey("OneTimePaymentStep2Id");

                    b.HasOne("ControlActive.Models.OneTimePaymentStep3", "Step3")
                        .WithMany()
                        .HasForeignKey("OneTimePaymentStep3Id");
            ...
            modelBuilder.Entity("ControlActive.Models.OneTimePaymentStep2", b =>
                {
                    b.HasOne("ControlActive.Models.OneTimePaymentAsset", "OneTimePaymentAsset")
                        .WithMany()
                        .HasForeignKey("OneTimePaymentAssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ControlActive.Models.SharesAndHolders", b =>
                {
                    ...
                    b.HasOne("ControlActive.Models.Shareholder", "Shareholder")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlActive.Models.Template", b =>
                {
                    b.HasOne("ControlActive.Models.FileModel", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("ShareShareholder", b =>
                {
                    b.HasOne("ControlActive.Models.Shareholder", null)
                        .WithMany()
                        .HasForeignKey("ShareholdersShareholderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ControlActive.Models.Share", null)
                        .WithMany()
                        .HasForeignKey("SharesShareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
