...
$('#myTable').on('click', 'tr td:not(:last-child)', function (evt) {
    ...
    if ($cell.index() > 0) {
        ...
        if (!data.isRead) {
            $.ajax({
                type: "POST",
                url: "/SimpleUser/Notis/MakeRead/",
                data: JSON.stringify(data.notiId),
                contentType: "application/json",
                success: function (data) {
                    if (data.success) {

                        getUnRead("/SimpleUser/Notis/GetNotifications/");
        ...
        window.location.href = "/SimpleUser/Notis/Details/?id=" + data.notiId + "&type=" + data.objectType + "&objectId=" + data.objectId;
    }
...
function DeleteAll() {
    ...
    Swal.fire({
        ...
        if (willDelete.isConfirmed) {
            $.ajax({
                type: "POST",
                url: "/SimpleUser/Notis/DeleteAll/",
...
$('#myTable').on('click', '.readSelectedBtn', function (evt) {
    ...
    if (isUnReadSelected) {
        $.ajax({
            type: "POST",
            url: "/SimpleUser/Notis/MakeReadAll/",
            data: JSON.stringify(ids),
            contentType: "application/json",
            success: function (data) {
                if (data.success) {
...
$('#myTable').on('click', '.unReadBtn', function () {
    ...
    $.ajax({
        type: "POST",
        url: "/SimpleUser/Notis/MakeUnRead/",
        data: JSON.stringify(data.notiId),
        contentType: "application/json",
        success: function (data) {
            if (data.success) {
...
$('#myTable').on('click', '.unReadSelectedBtn', function (evt) {
    ...
    if (isReadSelected) {
        $.ajax({
            type: "POST",
            url: "/SimpleUser/Notis/MakeUnReadAll/",
            data: JSON.stringify(ids),
            contentType: "application/json",
            success: function (data) {
                if (data.success) {
